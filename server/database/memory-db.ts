...
class MemoryDatabase {
  ...
  private seedData(): void {
    ...
    const categories = [
      {
        ...
        description: {
          en: "Fresh tropical fruits from exotic locations",
          vi: "Trái cây nhiệt đới tươi từ các vùng đất xa xôi",
        },
        emoji: "🥭",
      ...
      },
      {
        ...
        description: {
          en: "Antioxidant-rich berries for your health",
          vi: "Quả mọng giàu chất chống oxy hóa cho sức khỏe",
        },
        emoji: "🫐",
      ...
      },
      {
        ...
        description: {
          en: "Vitamin C packed citrus fruits",
          vi: "Trái cây họ cam chanh giàu vitamin C",
        },
        emoji: "🍋",
      ...
      },
      {
        ...
        description: {
          en: "Juicy stone fruits perfect for summer",
          vi: "Trái cây có hạt cứng ngon ngọt hoàn hảo cho mùa hè",
        },
        emoji: "🍑",
    ...
    const tropicalId = Array.from(this.categories.values()).find(
      (c) => c.slug === "tropical",
    )?.id!;
    const berriesId = Array.from(this.categories.values()).find(
      (c) => c.slug === "berries",
    )?.id!;
    ...
    const products = [
      {
        ...
        description: {
          en: "Fresh organic strawberries, perfect for desserts",
          vi: "Dâu tây hữu cơ tươi, hoàn hảo cho món tráng miệng",
        },
        price: 4.99,
        originalPrice: 6.99,
        image: "🍓",
      ...
      },
      {
        ...
        description: {
          en: "Sweet and creamy bananas, great for smoothies",
          vi: "Chuối ngọt và mềm, tuyệt vời cho sinh tố",
        },
        price: 2.49,
        image: "🍌",
        category: tropicalId,
      ...
      },
      {
        ...
        description: {
          en: "Crisp and sweet apples with amazing crunch",
          vi: "Táo giòn và ngọt với độ giòn tuyệt vời",
        },
        price: 3.99,
        originalPrice: 4.99,
        image: "🍎",
      ...
      },
      {
        ...
        description: {
          en: "Juicy oranges packed with vitamin C",
          vi: "Cam ngon ngọt giàu vitamin C",
        },
        price: 3.49,
        image: "🍊",
        category: citrusId,
